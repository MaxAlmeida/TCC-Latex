...
As próximas atividades deste trabalho serão concentradas na análise da intererência de desempenhos entre ambientes virtuais. Para tal, como apresentado  no capítulo \ref{cap:referencial_teorico}, já fora feita uma pesquisa prévia de trabalhos relacionados sobre o tema. Desse modo, a seguir são apresentads um cronograma com as atividades pretendidas para este trabalho.

\begin{itemize}
\item Definir de uma metodologia de pesquisa.
\item Avaliar trabalhos relacionados à desempenho de ambientes virtuais.
\item Definir os procedimentos adotados para estudo proposto.
\item Aplicar os procedimentos em um dos servidores físicos.
\item Coletar Resultados
