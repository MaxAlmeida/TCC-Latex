...
\label{fig:vm_infra}
\end{figure}
 %Outro procedimento adotado foi o uso de receitas \textit{chef} em conjunto com o \textit{chake} para automatização, tanto no provimento da plataforma em nuvem, quanto na disponibilização de serviços. O uso dessas ferramentas contribui para gerencia do serviços oferecidos, promovendo também um meio de compartilhamento de conhecimento através do código.A imagem a seg
